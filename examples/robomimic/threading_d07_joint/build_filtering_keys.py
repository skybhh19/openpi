"""Build checked LeRobot episode filters from Threading_D07 HDF5 masks."""
...
conversion = importlib.import_module("examples.robomimic.threading_d07_joint.convert_robomimic_data_to_lerobot")

DEFAULT_DATASET_PATH = Path("/iris/u/tiangao/lerobot_datasets/local/robomimic_threading_d07_joint_256")
...
def main(
    ...
    *,
    ...
    for mask_name, output_label in MASK_TO_OUTPUT_LABEL.items():
        output_path = destination / f"threading_d07_joint_256_{output_label}_episode_indices.json"
