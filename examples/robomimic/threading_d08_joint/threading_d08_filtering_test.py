"""Focused provenance tests for Threading_D08 subset filters."""
...
from examples.robomimic.threading_d08_joint import build_filtering_keys as filtering
...
def test_filter_mapping_rejects_overlapping_masks(tmp_path):
    ...
    # The manifest is deliberately stale after mutating the source; make it
    # match the new stat so validation reaches the overlap check.
