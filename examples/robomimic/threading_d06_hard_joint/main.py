...
from examples.robomimic.threading_d06_hard_joint import convert_robomimic_data_to_lerobot as conversion  # noqa: E402
...
class Args(joint_evaluation.Args):
    ...
    output_path: str = "data/robomimic_threading_d06_hard_joint_256_eval.json"
