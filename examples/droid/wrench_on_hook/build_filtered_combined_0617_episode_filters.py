"""Build LeRobot episode filters for the filtered-combined June 17 wrench-to-hook dataset."""
...
ANNOTATIONS_CSV = Path(__file__).with_name("wrench_to_hook_filtered_combined_0617_annotations.csv")
OUTPUT_DIR = Path(__file__).with_name("lerobot_filtering_keys")
RAW_DATA_DIR = Path("/iris/u/tiangao/projects/droid/data/success/wrench-to-hook-filtered-combined-0617")
LEROBOT_DATASET_DIR = Path("/iliad/u/tiangao/lerobot_datasets/skybhh19/droid_wrench_to_hook_filtered_combined_0617")

DATASET_NAME = "skybhh19/droid_wrench_to_hook_filtered_combined_0617"
ANNOTATION_DATASET = "wrench_to_hook_filtered_combined_0617"
FILE_PREFIX = "wrench_to_hook_filtered_combined_0617"
...
def build_filters(
    ...
    observability_manifest = {
        ...
        "label_counts": {
            ...
            "source_date": dict(Counter(row["source_date"] for row in rows)),
        },
        "filters": {},
    }
    ...
    for pct in FILTER_PCTS:
        ...
        observability_manifest["filters"][observability_filename] = {
            ...
            "source_date_counts": dict(Counter(rows[index]["source_date"] for index in observability_indices)),
