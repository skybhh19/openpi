...
#SBATCH --mem=256G
#SBATCH --gres=gpu
#SBATCH --job-name=pi05_droid_pen_in_blue_cup_07272026_observabilitypct50_low_mem_finetune # Name the job (for easier monitoring)
...
uv run scripts/train.py pi05_droid_pen_in_blue_cup_07272026_observabilitypct50_low_mem_finetune \
  --exp-name=pi05_droid_pen_in_blue_cup_07272026_observabilitypct50_low_mem_finetune \
  --resume
