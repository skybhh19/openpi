...
#SBATCH --mem=256G
#SBATCH --gres=gpu:1
#SBATCH --job-name=pi05_droid_pen_cup_low_mem_finetune_0605 # Name the job (for easier monitoring)
...
uv run --group rlds scripts/train.py pi05_droid_pen_cup_low_mem_finetune_0605 \
  --exp-name=pi05_droid_pen_cup_low_mem_finetune_0605 \
  --overwrite
